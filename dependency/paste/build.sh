...
set -e
python $(pwd)/../../build/pull_open_source.py "paste" "paste-3.4.0.tar.gz" "05834JPG"
...
TAR_SOURCE_FILE=paste-3.4.0.tar.gz
SOURCE_FILE=paste-3.4.0
[ -n "${SOURCE_FILE}" ] && rm -rf ${SOURCE_FILE}
